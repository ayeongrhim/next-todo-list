  ...
  return (
    <div className="flex gap-4 w-full">
      <input
        ...
        className="flex-1 h-[56px] rounded-full border-2 border-slate-900 bg-slate-100 px-6 text-slate-900 placeholder:text-slate-400 outline-none shadow-[2px_3.5px_0_0_#0F172A]"
      />
      {/* 데스크탑/태블릿 버튼 */}
      <button
